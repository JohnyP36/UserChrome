...
user_pref("userChrome+Content.page.focus_outline_hidden", false);
...
user_pref("userChrome+Content.rounding.square_menupopup", true);
...
user_pref("userChrome+Content.tab.close_button_at_hover_pinned.background", false);
user_pref("userChrome+Content.tab.show_(un)muted_icon_pinned", false);
user_pref("userChrome+Content.tab.show_muted_icon_when_soundplaying.only", true);
